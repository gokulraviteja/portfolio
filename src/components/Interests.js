        ...
        <div>
            ...
            <div className="interestsbody">
                ...
                <h3 className="uses-headings"> Tech </h3>
                    ...
                    <p class="uses-items"> <h4 className="item-color"> I use few data warehouse systems and data lakes like hive and s3 as if i live with them </h4> </p>     

                    <h3 className="uses-headings"> #Personal Stuff </h3>
                    <p class="uses-items"> <h4 className="item-color"> I like to explore new tech stacks and building stuff while learning (like the one which you are checking out right now - built on react)   </h4> </p>           
                    <p class="uses-items"> <h4 className="item-color"> I Code in Python, Javascript and use Django, React to make fun stuff quickly .  </h4> </p>           
                ...
                <div className="uses-body" id="nontech">
                    ...
                    <p class="uses-items"> <h4 className="item-color"> Always Up for more impromptu trips ✊  </h4> </p>                                                         
                    ...
                    <p class="uses-items"> <h4 className="item-color"> Foodie , Especially Chicken , Burger , Pizza , SoftDrinks , Chocolates  </h4> </p>                                                         
